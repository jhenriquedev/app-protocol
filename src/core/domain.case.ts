...
/**
 * Schema estrutural neutro do APP.
 *
 * Observação:
 * Este tipo foi mantido propositalmente simples.
 * No futuro, o protocolo pode adotar um formato mais formal
 * como JSON Schema, mas sem prender a base a um runtime específico.
 */
