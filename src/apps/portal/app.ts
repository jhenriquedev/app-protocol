 ...
 * --------------------------------------------------------------------------
 * Example host for a frontend portal application.
 *
 * The portal imports only UI surfaces from the registry.
 * It mounts views using the framework of choice (React, Vue, Svelte, etc.).
 *
 * The Cases are framework-agnostic. The host is where the framework lives.
 * ========================================================================== */
...
/* --------------------------------------------------------------------------
 * API client (connects UI to backend)
 * ------------------------------------------------------------------------ */
 ...
 * Bootstrap
 * --------------------------------------------------------------------------
 * In practice this would mount React/Vue/Svelte components.
 * The pattern is the same: iterate registry, instantiate UI Cases,
 * render views.
 * ------------------------------------------------------------------------ */
