...
Status: Released snapshot (`v0.0.7`)

Release alignment:

- snapshot version: [`v0.0.7`](./v0.0.7.md)
- earlier released snapshots: [`v0.0.6`](./v0.0.6.md), [`v0.0.5`](./v0.0.5.md), [`v0.0.4`](./v0.0.4.md), [`v0.0.2`](./v0.0.2.md), [`v0.0.1`](./v0.0.1.md)

This document is the released `v0.0.7` snapshot of the AI-First Programming Protocol.
...
### v0.0.8/v0.0.9 — Materialization and Validation
