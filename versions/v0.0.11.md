...
Status: Released snapshot (`v0.0.11`)

Release alignment:

- snapshot version: [`v0.0.11`](./v0.0.11.md)
- earlier released snapshots: [`v0.0.10`](./v0.0.10.md), [`v0.0.9`](./v0.0.9.md), [`v0.0.8`](./v0.0.8.md), [`v0.0.7`](./v0.0.7.md), [`v0.0.6`](./v0.0.6.md), [`v0.0.5`](./v0.0.5.md), [`v0.0.4`](./v0.0.4.md), [`v0.0.2`](./v0.0.2.md), [`v0.0.1`](./v0.0.1.md)

This document is the released `v0.0.11` snapshot of the AI-First Programming Protocol.
The living draft continues in [`../spec.md`](../spec.md).

Language policy:

- this snapshot is canonical in English
...
All host apps share the same protocol responsibilities, but their `app.ts` implementations are not expected to be identical. `apps/backend/app.ts`, `apps/portal/app.ts`, `apps/chatbot/app.ts`, and `apps/worker/app.ts` all play the same semantic role as host entrypoints, yet each adapts bootstrap, routing, tool registration, rendering, or background execution to its runtime.
...
### v0.1.0+ — Materialization and Validation
