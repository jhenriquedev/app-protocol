...
Status: Released snapshot (`v0.0.5`)

Release alignment:

- snapshot version: [`v0.0.5`](./v0.0.5.md)
- earlier released snapshots: [`v0.0.4`](./v0.0.4.md), [`v0.0.2`](./v0.0.2.md), [`v0.0.1`](./v0.0.1.md)

This document is the released `v0.0.5` snapshot of the AI-First Programming Protocol.
...
### v0.0.6/v0.0.7 — Materialization and Validation
