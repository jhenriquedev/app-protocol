...
- `v0.0.9` is the latest released snapshot and stabilizes `/app` with stronger onboarding, lifecycle operations, and native host coverage across Codex, Claude, GitHub Copilot, Windsurf, and compatible skill hosts.
