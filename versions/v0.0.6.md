...
Status: Released snapshot (`v0.0.6`)

Release alignment:

- snapshot version: [`v0.0.6`](./v0.0.6.md)
- earlier released snapshots: [`v0.0.5`](./v0.0.5.md), [`v0.0.4`](./v0.0.4.md), [`v0.0.2`](./v0.0.2.md), [`v0.0.1`](./v0.0.1.md)

This document is the released `v0.0.6` snapshot of the AI-First Programming Protocol.
...
- ~~Promote the optimized `/app` HML revision as the active operational skill~~ — `docs/skill_v4.md` is now the current HML, and mirrored `.codex` / `.claude` entrypoints now point to it
