...
export class TaskListUi extends BaseUiCase<ViewState> {
  ...
  public view(): ReactElement {
    ...
    const TaskListView = (): ReactElement => {
      ...
      const viewModel = this._viewmodel(state);
  ...
  public async test(): Promise<void> {
    ...
    const todoColumn = viewModel.columns.find((column) =>
      column.status === "todo"
    );
    const doingColumn = viewModel.columns.find((column) =>
      column.status === "doing"
    );
