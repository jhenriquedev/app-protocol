...
- `backend` for Deno API execution and local persistence ownership
- `portal` for React UI execution on Deno + Vite
...
- `server.ts` for the agent HTTP process entrypoint, including the remote MCP
  endpoint
