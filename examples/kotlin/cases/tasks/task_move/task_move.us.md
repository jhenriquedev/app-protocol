...
5. Structured `NOT_FOUND` and validation failures from `task_move.api` propagate through the agent host without being rewritten to generic runtime errors.
