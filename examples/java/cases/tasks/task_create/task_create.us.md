...
- It is triggered from the portal create-task flow.
...
1. Given the create-task flow is opened, submitting valid data triggers the backend request.
2. Given successful creation, the portal returns to the board and the new card is visible in `todo`.
