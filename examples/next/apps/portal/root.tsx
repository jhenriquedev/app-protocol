...
export function PortalRoot(props: PortalRootProps): ReactElement {
  ...
  const taskCreateView = new TaskCreateUi(taskCreateContext).view() as ReactElement;
  const taskListView = new TaskListUi(taskListContext).view() as ReactElement;

  return (
    <DesignSystem.AppShell
      title="Task Board"
      subtitle="Next.js + Node APP example with create, list, and move wired through Cases."
    >
