...
func (testHTTPClient) Request(config any) (any, error) {
	...
	body := record["body"].(TaskCreateInput)
...
func (testDesignSystem) CreateTaskForm(action string, titleValue string, descriptionValue string, errorMessage string) template.HTML {
